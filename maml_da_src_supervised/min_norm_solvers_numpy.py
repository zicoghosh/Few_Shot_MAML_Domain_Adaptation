...
class MinNormSolver():
    def __init__(self, max_iter=250, stop_eps=1e-6):
        self.max_iter = 250
        self.stop_eps = 1e-6
    ...
    def _min_norm_element_from2(self, v1v1, v1v2, v2v2):
        ...
        v2v2 = <x2,x2>
        """
        if v1v2 >= v1v1: # Case: Fig 1, third column
            gamma = 0.999
            cost = v1v1
        elif v1v2 >= v2v2: # Case: Fig 1, first column
            gamma = 0.001
            cost = v2v2
        else: # Case: Fig 1, second column
    ...
    def find_min_norm_element(self, vecs):
        ...
        while iter_count < self.max_iter:
            ...
            if np.sum(np.abs(change)) < self.stop_eps:
                return sol_vec, nd
            sol_vec = new_sol_vec   
        return sol_vec, nd
